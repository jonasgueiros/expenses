...
def open_window(script_name, *args):
    ...
    try:
        ...
        if not os.path.exists(script_path):
            messagebox.showerror("Error", f"O script '{script_name}.py' não foi encontrado.")
        ...
        messagebox.showerror("Error", f"Erro ao abrir a janela: {str(e)}")
...
class JanelaInicial:
    ...
    def on_close(self):
        ...
        self.root.destroy()  # Properly close the main window
    ...
    def abrir_config(self):
        open_window("config_interface")  # Single instance enforced
